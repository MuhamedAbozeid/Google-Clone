...
export const Results = () => {
  ...
  switch (location.pathname) {
    case '/search':
      return (
        <div className="sm:px-20 xl:px-40 2xl:px-44 flex flex-wrap justify-between space-y-6">
    ...
    case '/news':
      return (
        <div className="sm:px-20 xl:px-40 2xl:px-44 flex flex-wrap justify-between items-center space-y-6">
